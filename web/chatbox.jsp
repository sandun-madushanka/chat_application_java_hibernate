<%-- 
    Document   : chatbox
    Created on : Nov 10, 2017, 9:28:28 AM
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 contact-content">
                    <div class="lobby"><h6>Chat Room Public </h6></div>
                    <ul class="list-group">
                        <%                            LoadDaoImp loaddao = new LoadDaoImp();
                            ...
                            for (Object o : use) {
                                un = (User) o;
                                if (un.getUId() != currentuser) {
                        %>
                        <form method="GET" target="_blank" action="PrivateChat">
                            <li class="list-group-item contact-name">
                                <div class="input-group">
                                    <h6 class="form-control contact-name-group"><%  out.write(un.getUsername()); %></h6>
                                    <input type="text" value="<%  out.write("" + un.getUId()); %>" name="otheruser" hidden="">
                                    <input type="text" value="<%  out.write("" + currentuser); %>" name="currentuser" hidden="">
                                    <span class="input-group-btn">
                                        <button class="btn contact-name-btn" type="submit">Chat</button>
                                    </span>
                                </div>
                            </li>
                        </form>
...
<!--            <button onclick="twome()" type="button">click</button>
